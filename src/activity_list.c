...
int activity_list_destroy(activity_list_t* list) {
	if (!list) {
		return NO_LIST;
	}
	free(list->elements);
...
int activity_list_add(activity_list_t* list, activity_t e) {
...
int activity_list_get(activity_list_t* list, unsigned rank, activity_t* e) {
...
int activity_list_set(activity_list_t* list, unsigned rank, activity_t in, activity_t* out) {
...
int activity_list_size(activity_list_t* lista, unsigned* size) {
...
int activity_list_is_empty(activity_list_t* list) {
	if (list == NULL) return NO_LIST;
