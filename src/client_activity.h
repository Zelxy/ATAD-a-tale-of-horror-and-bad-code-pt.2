...
activity_list_t* clientactbst_get_client_activity(clientactbst_node_t*, char*);
clientactbst_node_t* clientactbst_search_node(clientactbst_node_t*, char*);//Searches tree for the node with the key
clientactbst_node_t* clientactbst_node_create(char*, activity_list_t);//initializes a node
...
void clientactbst_insert(clientactbst_node_t*, char*, activity_list_t);//Inserts a node into the tree
